export const GradeLevels = [
  ...
  { year: 12, name: 'Senior', objective: 'Tell your story', details: 'Senior year is a critical time for high school students as they finalize their college applications and prepare for the transition to higher education or other post-graduation paths. At this stage you should be perfecting your academic, time management and communication skills. Expect to make some early decisions on a career path by developing a resume, exploring internships/job shadowing. Prepare for higher education by keeping an eye on deadlines, finalizing a list of colleges and preparing to apply. Stay involved in the community and enjoy your last year in high school. ' }
]
